...
public class MainFrame extends javax.swing.JFrame {
    ...
    public void refreshAssignment(List<FlightDataModel.FlightViewModel> flights) {
        refreshFlights(flights);
        calculateAndSetStatistics(flights);
        setCurrentTime();
    }

    private void refreshFlights(List<FlightDataModel.FlightViewModel> flights) {
    ...
    private void calculateAndSetStatistics(List<FlightDataModel.FlightViewModel> flights) {
        if (flights.isEmpty()) {
        ...
        for (FlightDataModel.FlightViewModel flight : flights) {
    ...
    private class CalculationWorker extends SwingWorker<List<FlightDataModel.FlightViewModel>, Integer> {
        ...
        protected List<FlightDataModel.FlightViewModel> doInBackground() {
